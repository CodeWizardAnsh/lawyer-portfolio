        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {SERVICES.map((service, index) => (
            <Reveal key={service.id} delay={index * 150} className="h-full">
              <div className="group h-full relative bg-white p-8 shadow-sm hover:shadow-2xl transition-all duration-500 border-t-4 border-transparent hover:border-legal-gold flex flex-col transform hover:-translate-y-2">
